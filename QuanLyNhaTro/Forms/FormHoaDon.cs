...
namespace QuanLyNhaTro.Forms
{
    public partial class FormHoaDon : Form
    {
        ...
        private void txtChiSo_TextChanged(object sender, EventArgs e)
        {
            CalculateTotal();
        }
        ...
        {
            var selectedValue = cmbMaHopDong.SelectedValue;
            if (selectedValue is DataRowView drv)
            {
                selectedValue = drv["MaHopDong"];
            }
            ...
            SqlParameter[] p = { new("@MaHopDong", selectedValue) };
