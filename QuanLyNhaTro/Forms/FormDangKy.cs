...
namespace QuanLyNhaTro.Forms
{
    public partial class FormDangKy : Form
    {
        ...
        private bool ValidateInput()
        {
            ...
            {
                UIHelper.ShowWarningMessage("Tên đăng nhập phải có ít nhất 3 ký tự!");
                txtTenDangNhap.Focus();
                return false;
            }
        ...
        private void btnDangKy_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                // Tạo token xác thực (trong thực tế sẽ gửi qua email)
                ...
                // Tự động tạo bản ghi khách hàng
                ...
                string insertKhachHangQuery = @"
                    ...
                    VALUES (@MaKhach, @TenKhach, '', '', '', NULL, '', N'Tài khoản: ' + @TenDangNhap)";
                ...
                // Thông báo thành công (trong thực tế sẽ yêu cầu xác thực email)
